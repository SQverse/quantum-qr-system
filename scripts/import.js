...
// 1. Ambil Bulan Sekarang dalam Romawi (Misal: April = IV)
const monthRoman = toRoman(new Date().getMonth() + 1);

// 2. Pad Nomor Urut (Misal: 1 jadi 0001)
const sequence = String(id).padStart(4, '0');

// 3. Gabungkan jadi format LPKQ/ROMANI/URUTAN
const nomor_induk = `LPKQ/${monthRoman}/${sequence}`;
